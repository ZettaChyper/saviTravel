    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20">
        <div class="max-w-3xl animate-fade-in-left">
            <span class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-emerald-500/90 to-teal-500/90 backdrop-blur-sm rounded-full text-white text-sm font-semibold mb-6 animate-bounce-in">
                ...
                UNESCO World Heritage Sites & More
            </span>
            ...
            <nav class="mt-6 animate-fade-in-up" style="animation-delay: 0.6s;" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-gray-300">
                    ...
                    <li class="text-emerald-400 font-semibold">Destinations</li>
                </ol>
            </nav>
        </div>
    </div>
...
<section class="py-16 bg-gradient-to-b from-gray-50 to-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12 animate-fade-in-up">
            ...
            <h2 class="text-3xl font-display font-bold text-gray-900">Sri Lanka's Treasures</h2>
               ...
               class="group relative overflow-hidden rounded-2xl aspect-[4/5] shadow-lg card-3d animate-fade-in-up" style="animation-delay: {{ $loop->index * 0.1 + 0.2 }}s;">
                <div class="inner-card h-full">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                        <span class="text-emerald-400 text-sm font-medium">{{ $destination->country }}</span>
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            <span class="text-sm text-emerald-300 bg-emerald-500/20 px-3 py-1 rounded-full border border-emerald-500/30">{{ $destination->packages_count ?? 0 }} Packages</span>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 text-center animate-fade-in-up lift-hover border border-emerald-100" style="animation-delay: 0.1s;">
                <div class="w-14 h-14 mx-auto mb-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/30 float-animation">
            ...
            <div class="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6 text-center animate-fade-in-up lift-hover border border-teal-100" style="animation-delay: 0.2s;">
                <div class="w-14 h-14 mx-auto mb-4 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-xl flex items-center justify-center shadow-lg shadow-teal-500/30 float-animation">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 text-center animate-fade-in-up lift-hover border border-amber-100" style="animation-delay: 0.3s;">
                <div class="w-14 h-14 mx-auto mb-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl flex items-center justify-center shadow-lg shadow-amber-500/30 float-animation">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-br from-cyan-50 to-emerald-50 rounded-2xl p-6 text-center animate-fade-in-up lift-hover border border-cyan-100" style="animation-delay: 0.4s;">
                <div class="w-14 h-14 mx-auto mb-4 bg-gradient-to-r from-cyan-500 to-emerald-500 text-white rounded-xl flex items-center justify-center shadow-lg shadow-cyan-500/30 float-animation">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<section class="py-16 relative overflow-hidden">
    <div class="absolute inset-0">
        <img src="{{ asset('images/sri-lanka-beach.jpg') }}" alt="Sri Lanka Adventure" class="w-full h-full object-cover">
