    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="animate-fade-in-left">
                <span class="text-primary-600 font-semibold tracking-wider uppercase">Our Story</span>
            ...
            <div class="relative animate-fade-in-right">
                <div class="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl card-3d">
                ...
                <div class="absolute -bottom-8 -left-8 bg-white rounded-2xl shadow-xl p-6 max-w-xs animate-bounce-in" style="animation-delay: 0.5s;">
                    <div class="flex items-center gap-4">
                        <div class="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center float-animation">
                            <span class="text-2xl font-bold text-primary-600">14+</span>
                        </div>
                        <div>
...
{{-- Stats --}}
<section class="py-16 bg-gradient-to-r from-primary-600 to-accent-600 relative overflow-hidden">
...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-fade-in-up">
            <span class="text-primary-600 font-semibold tracking-wider uppercase">Why Choose Us</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-8 shadow-lg text-center lift-hover animate-fade-in-up" style="animation-delay: 0.1s;">
                <div class="w-16 h-16 mx-auto mb-6 bg-primary-100 rounded-2xl flex items-center justify-center float-animation">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg text-center lift-hover animate-fade-in-up" style="animation-delay: 0.2s;">
                <div class="w-16 h-16 mx-auto mb-6 bg-accent-100 rounded-2xl flex items-center justify-center float-animation" style="animation-delay: 0.2s;">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg text-center lift-hover animate-fade-in-up" style="animation-delay: 0.3s;">
                <div class="w-16 h-16 mx-auto mb-6 bg-green-100 rounded-2xl flex items-center justify-center float-animation" style="animation-delay: 0.4s;">
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-fade-in-up">
            <span class="text-primary-600 font-semibold tracking-wider uppercase">Our Team</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div class="text-center animate-fade-in-up" style="animation-delay: 0.1s;">
                <div class="w-40 h-40 mx-auto mb-6 rounded-full overflow-hidden shadow-lg tilt-effect">
                ...
                <p class="text-primary-600 mb-2">Founder & CEO</p>
            ...
            <div class="text-center animate-fade-in-up" style="animation-delay: 0.2s;">
                ...
                <p class="text-primary-600 mb-2">Head of Operations</p>
            ...
            <div class="text-center animate-fade-in-up" style="animation-delay: 0.3s;">
                ...
                <p class="text-primary-600 mb-2">Senior Travel Consultant</p>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-70">
            <div class="text-center animate-fade-in-up" style="animation-delay: 0.1s;">
                <div class="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span class="text-gray-500 text-xs font-bold">SLTDA</span>
                </div>
                <p class="text-sm text-gray-500">Sri Lanka Tourism</p>
            </div>
            <div class="text-center animate-fade-in-up" style="animation-delay: 0.2s;">
                <div class="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span class="text-gray-500 text-xs font-bold">IATA</span>
                </div>
                <p class="text-sm text-gray-500">IATA Member</p>
            </div>
            <div class="text-center animate-fade-in-up" style="animation-delay: 0.3s;">
                <div class="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span class="text-gray-500 text-xs font-bold">PATA</span>
                </div>
                <p class="text-sm text-gray-500">PATA Member</p>
            </div>
            <div class="text-center animate-fade-in-up" style="animation-delay: 0.4s;">
                <div class="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span class="text-gray-500 text-xs font-bold">THASL</span>
                </div>
